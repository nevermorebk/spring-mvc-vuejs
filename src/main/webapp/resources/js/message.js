...
$.ajax({
    ...
    $.each(data, function (i, o) {
        ...
        $.each(o.list, function (i, o) {
            $("#list").append('<li><a href=""><span class="mail-sender">Send by:' + title +'</span>'+
            '<span class="mail-subject">Title: ' + o.title + '</span>' +
                    '<span class="mail-subject">Date: '+ o.date +'</span>' +
                    '<span class="mail-message-preview">Content: '+ o.content +'</span></a></li>'
            );
        })
    ...
    console.log("Complete Call Ajax!");
});
